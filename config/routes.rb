ActionController::Routing::Routes.draw do |map|
  ...
  map.fb_connect "/fbconnect", :controller=>"facebook", :action=>"fb_connect"
  map.fb_connect_callback "/fbconnect/callback", :controller=>"facebook", :action=>"fb_connect_callback"
